...
import { ImageDropdown, ImageDropdownOptions, ImageDropdownStyle, ImageOption } from "./ImageDropdown";

export default class ColorChooserComponent {
    ...
    render(): void {
        ...
        const def = this.colors.filter((color) => {
